document.addEventListener("DOMContentLoaded", () => {
  google.script.run.withSuccessHandler(preencherDropdowns).listarOpcoes(); // AppsScript (backend) deve retornar um objeto com listas nomeadas
});
...
function onSalvarContratoSucesso(response) {
  ...
  document.querySelector("#num_sesp").focus();
}
